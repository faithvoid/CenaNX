...
define build.itch_project = "Lazlo319/john-cena-vn"
...
init -1 python hide:
    ...
    config.window_title = "John Cena Sexy High-School Adventure!!!"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "JohnCenaSchool"
    config.version = "1.11"
...
python early:
    config.save_directory = "JohnCenaSchool-1409559132"
...
init python:
    ...
    build.directory_name = "JohnCenaSchool-1.11"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "JohnCenaSchool"
